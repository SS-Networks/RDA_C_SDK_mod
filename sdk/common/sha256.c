...
inline void Sha256_Update(CSha256 *p, const Byte *data, size_t size)
{
...
inline void Sha256_Final(CSha256 *p, Byte *digest)
{
...
inline void Sha256_Onestep(const Byte *data, size_t size, Byte *digest)
{
    CSha256 p;
    Sha256_Init(&p);
